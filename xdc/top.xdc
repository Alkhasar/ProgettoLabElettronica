...
set_input_delay -clock fpga_clk 2.000 [get_ports INT];
set_input_delay -clock fpga_clk 2.000 [get_ports DB*];
set_input_delay -clock fpga_clk 2.000 [get_ports rst];
...
##   push-buttons   ##
######################
set_property -dict { PACKAGE_PIN D9  IOSTANDARD LVCMOS33 } [get_ports rst];             # BUTTON [0]

########################
##   Pmod header JA   ##
########################
set_property -dict { PACKAGE_PIN G13  IOSTANDARD LVCMOS33 } [get_ports INT];            # Ja[1]
set_property -dict { PACKAGE_PIN B11  IOSTANDARD LVCMOS33 } [get_ports WR];             # Ja[2]
...
##   Pmod Header JB   ##
######################## 
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { adc_data[0] }]; # Jb[1] 
...
##   Pmod Header JD   ##
######################## 
set_property -dict { PACKAGE_PIN D4  IOSTANDARD LVCMOS33 } [get_ports { DB[0] }]; # Jd[1] 
